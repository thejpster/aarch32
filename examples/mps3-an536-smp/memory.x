...
PROVIDE(_hyp_stack_size = 4K);
PROVIDE(_und_stack_size = 4K);
PROVIDE(_svc_stack_size = 4K);
PROVIDE(_abt_stack_size = 4K);
PROVIDE(_irq_stack_size = 4K);
PROVIDE(_fiq_stack_size = 4K);
